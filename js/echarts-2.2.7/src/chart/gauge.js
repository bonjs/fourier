...
define(function (require) {
    ...
    Gauge.prototype = {
        ...
        _buildSplitLine: function (seriesIndex) {
            ...
            var sinAngle;
            var cosAngle;
            for (var i = 0; i <= splitnumber;="" i++)="" {="" angle="startAngle" -="" totalangle="" splitnumber="" *="" i;="" sinangle="Math.sin(angle);" cosangle="Math.cos(angle);" this.shapelist.push(new="" lineshape({="" zlevel:="" serie.zlevel,="" z:="" serie.z="" +="" 1,="" hoverable:="" false,="" style:="" xstart:="" center[0]="" r,="" ystart:="" center[1]="" xend:="" r0,="" yend:="" strokecolor:="" color="==" 'auto'="" ?="" this._getcolor(seriesindex,="" min="" total="" i)="" :="" color,="" linetype:="" linestyle.type,="" linewidth:="" linestyle.width,="" shadowcolor:="" linestyle.shadowcolor,="" shadowblur:="" linestyle.shadowblur,="" shadowoffsetx:="" linestyle.shadowoffsetx,="" shadowoffsety:="" linestyle.shadowoffsety="" }="" }));="" },="" 小标记="" _buildaxistick:="" function="" (seriesindex)="" var="" serie="this.series[seriesIndex];" if="" (!serie.axistick.show)="" return;="" params="this._paramsMap[seriesIndex];" min;="" axistick="serie.axisTick;" ticksplit="axisTick.splitNumber;" length="this.parsePercent(axisTick.length," params.radius[1]);="" linestyle="axisTick.lineStyle;" center="params.center;" startangle="params.startAngle" math.pi="" 180;="" r="params.radius[1];" r0="r" length;="" angle;="" sinangle;="" cosangle;="" for="" (var="" i="0," l="splitNumber" ticksplit;="" <="l;" (i="" %="" 0)="" 同splitline="" continue;="" 坐标轴文本="" _buildaxislabel:="" (!serie.axislabel.show)="" textstyle="serie.axisLabel.textStyle;" textfont="this.getFont(textStyle);" this.parsepercent(serie.splitline.length,="" params.radius[1])="" 5;="" value;="" value="accMath.accAdd(" ,="" accmath.accmul(accmath.accdiv(total="" splitnumber),="" );="" 180);="" 360)="" 360;="" textshape({="" x:="" y:="" color:="" value)="" text:="" this._getlabeltext(serie.axislabel.formatter,="" value),="" textalign:="" (angle="">= 110 && angle <= 250)="" ?="" 'left'="" :="" (angle="" <="70" ||="" angle="">= 290)
                                       ? 'right'
                                       : 'center',
